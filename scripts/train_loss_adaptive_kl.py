...
def train_loss_adaptive_kl(student, teacher, loader, optimizer, device, cfg):
    student.train()
    teacher.eval()
    ...
    for batch in tqdm(loader):
        ...
        # Adaptive lambda (loss ratio)
        lam = float(l_cls.detach() / (l_cls.detach() + l_distill.detach() + cfg.epsilon))
